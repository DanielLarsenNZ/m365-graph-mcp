  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        from: { type: "string", description: "Sender address — must be an alias or shared mailbox on the account e.g. alias@example.com" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        from: { type: "string", description: "Sender address override e.g. alias@example.com" },
